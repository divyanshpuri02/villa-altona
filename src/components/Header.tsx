            ...
            {userEmail && (
              <div className="relative">
                <motion.button
                  ...
                  className="flex items-center gap-2 text-sm text-black hover:text-gray-300 transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/20"
                ...
                <AnimatePresence>
                  {isUserMenuOpen && (
                    <motion.div
                      ...
                      transition={{ duration: 0.2 }}
                      className="absolute right-0 top-full mt-2 w-48 bg-black rounded-lg shadow-lg border border-gray-200 py-2 z-50"
                    >
                      <motion.button
                        onClick={() => {
                          onLogout?.();
