          ...
          {user && (
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-10 p-2 rounded-md text-black hover:text-gray-300 transition-colors duration-200"
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white/95 backdrop-blur-md rounded-md shadow-lg py-1 z-50 border border-white/20">
                  ...
                  <button
                    ...
                    className="flex items-center w-full px-4 py-2 text-sm text-black hover:bg-white/20 text-red transition-colors duration-200"
                  >
